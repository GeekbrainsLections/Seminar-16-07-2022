...
## Подключение к удаленному репозиторию чужого проекта.
Чтобы участвовать в чьем-то проекте необходимо выполнить следующие действия:
1. На странице Github выбранного репозитория нажать кнопку *fork*.
2. Скопировать репозиторий в свой аккаунт. Скопированный репозиторий будет нашим и мы можем делать с ним все что хотим.
3. Скопировать ссылку репозитория, предварительно нажав копку *code*.
4. Склонировать репозиторий в свой компьютер в папку не являющимся репозиторием с помощью команды *git clone < ссылка на проект>*.
5. Перейти в новый репозиторий с помощью команды *сd <название репозитория>*.
6. Создаем отдельную ветку и в ней файл с описанием проекта Readme.md
7. Делаем изменения, сохраняем и коммитим.
8. Отправляем на Github в наш аккаунт с помощью команды git push origin master
9. Отправляем запрос на включение в проект на странице репозитория в Github c помощью раздела pull request  
