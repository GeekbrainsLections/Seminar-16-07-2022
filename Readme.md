...
Для того, чтобы просмотреть список веток репозитория применяется команда *git branch -a*
...
## Назначение главной ветки в удаленном репозитории
Для назначения главной ветки в удаленном репозитории используется команда *git branch -M <название главной ветки>*

## Связка локального репозитория с удаленным
Для того, чтобы связать локальный репозиторий с удаленным применяется команда *git remote add origin <адрес удаленного репозитория>*

## Удаление связки локального репозитория с удаленным
Для того, чтобы удалить связь локального репозитория с удаленным применяется команда *git remote add origin <адрес удаленного репозитория>*
...
## Открытие удаленного репозитория в терминале
Для того, чтобы открыть папку полученного удаленного репозитория в терминале применяется команда *cd <название папки>*
