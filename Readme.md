...
Для того, чтобы выполнить команду *pul request*, необходимо:

1. Сделать *fork* интересующего нас репозитория.
2. Ввыполнить команду *git clone* для нашей версии этого репозитория.
3. Создать **НОВУЮ** ветку с предлагаемыми изменениями.
4. Произвести изменения только в этой ветке. Все изменения зафиксировать с помощью команды *git commit -m ""*.
5. Отправить свою версию в свой аккаунт на **Github** с помощью команды *git push*.
