...
## Fork'и репозиториев
Мы можем сделать **fork** интересующего нас репозитория, т.е. **создать клон этого репозитория**, но уже принадлежащий полностью нам, так мы, например, сможем вносить изменения напрямую в клонированный репозиторий, а потом предлагать свои изменения оригинальному репозиторию.
