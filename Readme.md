...
## Fork'и репозиториев
Мы можем сделать **fork** интересующего нас репозитория, т.е. **создать клон этого репозитория**, но уже принадлежащий полностью нам, так мы, например, сможем вносить изменения напрямую в клонированный репозиторий, а потом предлагать свои изменения оригинальному репозиторию. Чтобы сделать **fork** необходимо открыть интересующий нас репозиторий на _**GitHub**_ и нажать кнопку **"Fork"** в левом верхнем углу, после этого репозиторий добавится в ваш профиль.
...
## Как "подружить" локальный и удалённый репозитории 
Для того, чтобы подружить удалённый и локальный репозитории необходимо использовать команду *git add remote <ссылка на удалённый репозиторий>*. В терминале, в котором открыта папка с клонированным репозиторием, необходимо написать *git add remote <ссылка на репозиторий>*. 
...
После отправки изменений в удалённый репозиторий (с помощью команды **git push**) в окне на GitHub появится кнопка создания **pull request**. С помощью **pull request** мы можем предложить свои изменения в любой, интересующий нас, репозиторий.
