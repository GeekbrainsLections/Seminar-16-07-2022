...
Для создания нового репозитория на GitHub необходимо авторизоваться в своем аккаунте. Переходим в меню "Yuor repositories" и кликаем на кнопоке "New". Открывается окно, в котором будет предложено дать имя создаваемому репозиторию,
сделать его Public или Private, а также сразу будет предложено создать некторые файлы. Отмечаем необходимое и кликаем на кнопке "Create repositry". 